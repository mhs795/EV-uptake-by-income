...
.txt <- function(sz = 800, col = "6B7280", bold = FALSE) {
  sprintf(
    '<c:txPr><a:bodyPr/><a:lstStyle/><a:p><a:pPr><a:defRPr sz="%d" b="%d">%s<a:latin typeface="Arial"/></a:defRPr></a:pPr><a:endParaRPr lang="en-AU"/></a:p></c:txPr>',
    sz, as.integer(bold), .fill(col)
  )
}
.title <- function(text, sz = 1100) {
  sprintf(
    '<c:title><c:tx><c:rich><a:bodyPr/><a:lstStyle/><a:p><a:pPr><a:defRPr sz="%d" b="1">%s<a:latin typeface="Arial"/></a:defRPr></a:pPr><a:r><a:rPr lang="en-AU" sz="%d" b="1">%s<a:latin typeface="Arial"/></a:rPr><a:t>%s</a:t></a:r></a:p></c:rich></c:tx><c:overlay val="0"/></c:title>',
...
chart_line <- function(title, sheet, cats, series, y_fmt = "0%", y_title = NULL, date = TRUE) {
  sers <- vapply(seq_along(series), function(i) {
    s <- series[[i]]
    sprintf(
      '<c:ser><c:idx val="%d"/><c:order val="%d"/>%s<c:spPr><a:ln w="22225" cap="rnd">%s%s<a:round/></a:ln></c:spPr><c:marker><c:symbol val="none"/></c:marker><c:cat><c:numRef><c:f>%s</c:f></c:numRef></c:cat><c:val><c:numRef><c:f>%s</c:f></c:numRef></c:val><c:smooth val="0"/></c:ser>',
      i - 1, i - 1, .tx(s$name), .fill(s$colour), if (isTRUE(s$dash)) '<a:prstDash val="dash"/>' else "",
      .ref(sheet, cats), .ref(sheet, s$ref)
    )
  }, "")
  .wrap(title, paste0(
    '<c:lineChart><c:grouping val="standard"/><c:varyColors val="0"/>', paste(sers, collapse = ""),
...
chart_bar <- function(title, sheet, cats, series, y_fmt = "#,##0", dir = "col", grouping = "clustered", date = FALSE,
  ...
  sers <- vapply(seq_along(series), function(i) {
    s <- series[[i]]
    sprintf(
      '<c:ser><c:idx val="%d"/><c:order val="%d"/>%s<c:spPr>%s<a:ln w="6350">%s</a:ln></c:spPr><c:invertIfNegative val="0"/><c:cat><c:%s><c:f>%s</c:f></c:%s></c:cat><c:val><c:numRef><c:f>%s</c:f></c:numRef></c:val></c:ser>',
  ...
  plot <- paste0(
    sprintf('<c:barChart><c:barDir val="%s"/><c:grouping val="%s"/><c:varyColors val="0"/>', dir, grouping),
    paste(sers, collapse = ""),
...
chart_scatter <- function(title, sheet, x, y, colour, x_title, y_title, x_fmt = "$#,##0", y_fmt = "0%") {
  ser <- sprintf(
    '<c:ser><c:idx val="0"/><c:order val="0"/>%s<c:spPr><a:ln w="19050"><a:noFill/></a:ln></c:spPr><c:marker><c:symbol val="circle"/><c:size val="6"/><c:spPr>%s<a:ln w="6350">%s</a:ln></c:spPr></c:marker><c:xVal><c:numRef><c:f>%s</c:f></c:numRef></c:xVal><c:yVal><c:numRef><c:f>%s</c:f></c:numRef></c:yVal><c:smooth val="0"/></c:ser>',
